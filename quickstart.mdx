...
Let's start with a simple "Hello world" example. Open a terminal and run:

```bash
ollama run gemma3 "Hello world"
```

This will download the model (if not already present) and return a response to your "Hello world" message.
