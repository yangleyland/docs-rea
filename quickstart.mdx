...
Once Ollama is installed, you can test it with a simple "hello world" command:

```bash
ollama run gemma3 "Hello world"
```

This will download the gemma3 model (if not already downloaded) and respond to your greeting.
