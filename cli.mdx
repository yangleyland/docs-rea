...
... multiline text
... here"""
I'm a basic program that prints a greeting message to the console.
```
...
```
ollama run embeddinggemma "Sample text for embedding"
```

Output is a JSON array:

```
echo "Sample text for embedding" | ollama run nomic-embed-text
```
